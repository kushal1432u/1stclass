...
def preprocess_sms(sms_text):
    ...
    """
    # 1. Remove special characters (less aggressively) and keep numbers
    # Retain alphanumeric characters and some common punctuation like .,!?-@
    cleaned_text = re.sub(r'[^a-zA-Z0-9\s.,!?-]', '', sms_text)
    ...
    # 4. Lemmatization (defaulting to noun if pos is not specified)
